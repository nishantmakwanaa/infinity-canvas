...
export function useCanvasCollaboration(
  ...
  }, [applyStoredSnapshotForUser, broadcastSnapshot, canvasId, claimEditorSlot, enabled, identity, reconnectNonce, releaseEditorSlot, requireEditorSlot, scheduleReconnect, sendPresence, syncCurrentSnapshotToRoom]);
